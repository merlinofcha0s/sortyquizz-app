...
List<Question> _addQuestion(List<Question> questions, AddQuestionAction action) {
  return List.from(questions)..add(action.question);
}

List<Question> _setLoadedQuestions(List<Question> questions, QuestionsLoadedAction action) {
  return action.questions;
}

List<Question> _setNoQuestions(List<Question> questions, QuestionsNotLoadedAction action) {
  return [];
}
